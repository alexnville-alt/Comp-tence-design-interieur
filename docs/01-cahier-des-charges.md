...
> **Portée** : définit _quoi_ construire et _pour qui_. Le _comment_ est dans
...
- **Aucun retour sur son travail** — un débutant qui aménage son salon n'a
  personne pour lui dire _pourquoi_ sa composition ne fonctionne pas.
...
2. **Un atelier de conception intégré** — on apprend une notion puis on
   l'applique _immédiatement_ sur son propre plan, dans le même outil.
...
| AI-02 | Réponses pédagogiques avec le _pourquoi_ (règle invoquée) et 2–3 alternatives                                                                            | M    |
