...
-- CreateEnum
CREATE TYPE "AiFeature" AS ENUM ('CHAT', 'PHOTO_ANALYSIS', 'GRADING', 'GENERATOR', 'CRITIQUE');

-- AlterEnum
ALTER TYPE "ExerciseType" ADD VALUE 'OPEN_CASE';

-- AlterTable
ALTER TABLE "Submission" ADD COLUMN     "feedback" JSONB;
